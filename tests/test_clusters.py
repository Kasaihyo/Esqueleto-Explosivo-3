...
class TestClusterDetection(unittest.TestCase):
    ...
    def test_cluster_detection_with_wilds(self):
        ...
        symbol, coords = clusters[0]
        self.assertEqual(
            symbol.name, "ORANGE_SK"
        )  # Should identify as ORANGE_SK cluster
        ...
        self.assertSetEqual(
            set(coords),
            {
                (1, 1),
                (1, 2),
                (1, 3),  # Top row ORG, WILD, ORG
                (2, 2),  # Middle WILD
                (3, 2),
                (3, 3),
                (3, 4),  # Bottom row ORG, ORG, ORG
            },
        )
    ...
    def test_cluster_detection_multiple_clusters(self):
        ...
        self.assertSetEqual(
            set(coords_blu), {(2, 3), (2, 4), (3, 3), (3, 4), (4, 3), (4, 4)}
        )
        ...
        self.assertSetEqual(
            set(coords_grn), {(2, 0), (2, 1), (3, 0), (3, 1), (4, 0), (4, 1)}
        )
